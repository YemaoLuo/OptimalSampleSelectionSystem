...
public class MostOptimizeSolution {
    ...
    public static void optimizeSolution() {
        ...
        MostSolutionHelper mos = new MostSolutionHelper();
        int m = sc.nextInt(), n = sc.nextInt(), k = sc.nextInt(), j = sc.nextInt(), s = sc.nextInt();
        long startTime = System.currentTimeMillis();
        System.out.println("=====================================");

        long tempTime = System.currentTimeMillis();
        List<Integer> chosenSamples = mos.generateChosenSamples(m, n);
        ...
        List<List<Integer>> possibleResults = mos.generatePossibleResults(chosenSamples, k);
        ...
        tempTime = System.currentTimeMillis();
        List<Set<Integer>> coverList = mos.generateCoverList(chosenSamples, j);
