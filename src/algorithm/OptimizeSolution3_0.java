...
public class OptimizeSolution3_0 {
    ...
    public static void optimizeSolution() {
        ...
        System.out.println("Generate chosen samples time cost: " + (System.currentTimeMillis() - tempTime) + " ms");
        System.out.println("=====================================");
        ...
        System.out.println("Generate possible results time cost: " + (System.currentTimeMillis() - tempTime) + " ms");
        System.out.println("=====================================");
        ...
        System.out.println("Generate cover list time cost: " + (System.currentTimeMillis() - tempTime) + " ms");
        System.out.println("=====================================");

        tempTime = System.currentTimeMillis();
        System.out.println("Build graph time cost: " + (System.currentTimeMillis() - tempTime) + " ms");

        tempTime = System.currentTimeMillis();
        List<List<Integer>> result = sh.getResult(possibleResults, coverList, s);
        System.out.println("Result: " + result);
        System.out.println("Result size: " + result.size());
        System.out.println("Get result time cost: " + (System.currentTimeMillis() - tempTime) + " ms");
        System.out.println("=====================================");
